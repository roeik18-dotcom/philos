...
export default function WeeklyReportSection({ userId }) {
  ...
  return (
    <section className="philos-section bg-white border-border animate-section animate-section-3" dir="rtl" data-testid="weekly-report-section">
      {/* Header */}
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-emerald-700">דוח שבועי</span>
        </div>
        <span className="text-xs text-gray-400">{data.days_active} ימים פעילים</span>
      </div>
      ...
      {data.total_actions > 0 ? (
        ...
        <div className="text-center py-4 text-gray-400 text-sm mb-4">אין נתונים השבוע</div>
      )}
      ...
      <div className="flex items-center justify-around text-center border-t border-gray-100 pt-3">
        <div className="flex flex-col items-center gap-1" data-testid="report-streak">
          ...
          <span className="text-[10px] text-gray-500">רצף</span>
        </div>
        <div className="flex flex-col items-center gap-1" data-testid="report-mission">
          ...
          <span className="text-[10px] text-gray-500">משימות</span>
        </div>
