...
export default function ActiveUsersIndicator() {
  ...
  return (
    <div className="flex items-center justify-center gap-4 text-xs text-gray-500 mt-1.5 animate-section animate-section-1" dir="rtl" data-testid="active-users-indicator">
