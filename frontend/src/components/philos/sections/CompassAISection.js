...
export default function CompassAISection({ userId }) {
  ...
  return (
    <section className="philos-section bg-white border-border" data-testid="compass-ai-section">
      <div className="flex items-center gap-2 mb-4">
        ...
        <div>
          <span className="text-sm font-semibold text-gray-800">Your Compass</span>
        ...
        <>
          ...
          <div className="flex gap-3 mb-4">
            <div className="flex-1 rounded-xl p-3 text-center" style={{ backgroundColor: `${domColor}08`, border: `1px solid ${domColor}20` }}>
              ...
              <p className="text-[9px] text-gray-400">Dominant direction</p>
            </div>
            <div className="flex-1 rounded-xl p-3 text-center" style={{ backgroundColor: `${weakColor}08`, border: `1px solid ${weakColor}20` }}>
              ...
              <p className="text-[9px] text-gray-400">Weak direction</p>
            </div>
          </div>
          ...
          <div className="mb-4">
            <div className="flex items-center justify-between mb-1">
              <span className="text-[10px] text-gray-400">Direction balance</span>
          ...
          <div className="bg-cyan-50 rounded-xl p-3 border border-cyan-100" data-testid="compass-ai-suggestion">
            <div className="flex items-center gap-1.5 mb-1">
              ...
              <span className="text-[10px] font-semibold text-cyan-700">Suggested action</span>
            </div>
