      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1">
            {insights.total_replays} replays | {insights.recent_replay_count} this week
          </p>
        </div>
      </div>
        ...
        <div className="space-y-4">
          ...
          {sortedAltPaths.length > 0 && (
            <div className="bg-white/60 rounded-xl p-4">
              <h4 className="text-sm font-medium text-foreground mb-3 flex items-center gap-2">
                ...
                The most checked alternative paths
              </h4>
              ...
              <div className="space-y-2">
                {insights.blind_spots.map((spot, idx) => (
                  ...
                  >
                    ...
                    <span>
                      You never checked a path of <strong>{valueLabels[spot.to]}</strong> after a decision of <strong>{valueLabels[spot.from]}</strong>
                    </span>
                  </div>
                ))}
              </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="bg-white/60 rounded-xl p-3 text-center">
              ...
              <div className="text-xs text-muted-foreground">Total replays</div>
            </div>
            <div className="bg-white/60 rounded-xl p-3 text-center">
              <div className="text-2xl font-bold text-violet-600">
                {insights.transition_patterns?.length || 0}
              </div>
              <div className="text-xs text-muted-foreground">Transition patterns</div>
            </div>
            <div className="bg-white/60 rounded-xl p-3 text-center">
              <div className="text-2xl font-bold text-amber-600">
                {insights.blind_spots?.length || 0}
              </div>
              <div className="text-xs text-muted-foreground">Blind spots</div>
            </div>
          </div>
        </div>
      )}
