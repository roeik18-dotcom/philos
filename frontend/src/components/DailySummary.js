...
export default function DailySummary({ todayRequests, onNewRequest }) {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-semibold text-foreground text-center">Today's Summary</h2>
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center justify-between p-4 rounded-2xl bg-background/50">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg">Helped</span>
          </div>
        ...
        <div className="flex items-center justify-between p-4 rounded-2xl bg-background/50">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg">No Helped</span>
          </div>
