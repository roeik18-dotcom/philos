...
| Preview URL | https://orientation-paths.preview.emergentagent.com |
...
# Test API
API_URL=https://orientation-paths.preview.emergentagent.com
curl -s "$API_URL/api/"
```
...
**Live App:** https://orientation-paths.preview.emergentagent.com
